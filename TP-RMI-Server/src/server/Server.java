...
public class Server extends UnicastRemoteObject implements Observer{
	...
	public void init(String[] args) {
		try {	
			...
			// Ex 4:
	        System.setProperty("java.rmi.server.codebase", "file:/home/martin/Desktop/EclipseWorkspace/TP-RMI-Client/bin");

			 
			// Ex1:
			Animal cat = new Animal("Zizoo", "Martin", "Chat","Domestique");
